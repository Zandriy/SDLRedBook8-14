...
void OGL_Application::handleKeyPress( SDL_keysym *keysym )
{
	...
	case SDLK_a:
		...
		break;
	case SDLK_s:
		m_OGL_Consumer->setSample(m_curSample = 21);
		resizeWindow( 500, 500 );
		break;
	case SDLK_d:
		m_OGL_Consumer->setSample(m_curSample = 22);
		resizeWindow( 500, 500 );
		break;
	case SDLK_f:
		m_OGL_Consumer->setSample(m_curSample = 23);
		resizeWindow( 500, 500 );
		break;
	case SDLK_g:
		m_OGL_Consumer->setSample(m_curSample = 24);
		resizeWindow( 500, 500 );
		break;
	case SDLK_h:
		m_OGL_Consumer->setSample(m_curSample = 25);
		resizeWindow( 500, 500 );
		break;
	case SDLK_j:
		m_OGL_Consumer->setSample(m_curSample = 26);
		resizeWindow( 500, 500 );
		break;
	case SDLK_k:
		m_OGL_Consumer->setSample(m_curSample = 27);
		resizeWindow( 500, 500 );
		break;
	case SDLK_l:
		m_OGL_Consumer->setSample(m_curSample = 28);
		resizeWindow( 500, 500 );
		break;
	case SDLK_z:
	...
	case SDLK_x:
		...
		break;
	case SDLK_c:
		m_OGL_Consumer->setSample(m_curSample = 31);
		resizeWindow( 200, 200 );
		break;
	case SDLK_v:
		m_OGL_Consumer->setSample(m_curSample = 32);
		resizeWindow( 100, 100 );
		break;
	case SDLK_b:
		m_OGL_Consumer->setSample(m_curSample = 33);
